...
class Program
{
    static void Main(string[] args)
    {
        ...
        /*
         *  The for statement: executes its body whule a specified Boolean expression 
         *  evaluates to true.
        ...
        //this is a simple array with 10 items in it. you will learn more about arrays on
        //module 7

        string[] simpleArray = new string[] { "eleifend", "donec", "pretium", "vulputate", "sapien", "nec", "saggitis", "aliquam", "malesuada", "bibendum" };
        ...
        /*
         * The do statement executes a statement or block of ststements while a specified
        ...
        do
        {
            ...
            counter2++; // incremet counter2 by 1
        } while (counter2 < 10); // loop until counter2 is equal to 10 or >
         ...
         * evaluated before each execution of the loop, a while loop executes zero or
         * more times. The while statement differs from a do loop, which executes one 
         * or more times
         */
